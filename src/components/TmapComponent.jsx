...
const TmapComponent = () => {
    ...
    const initTmap = () => {
      if (!tmapInstanceRef.current && window.Tmapv2 && mapRef.current) {
        ...
        const marker = new window.Tmapv2.Marker({
          position: new window.Tmapv2.LatLng(35.8386809, 129.2880871), // 마커의 위치 설정
        ...
        // 지도 클릭 이벤트 핸들러 추가
        // tmapInstanceRef.current.on("click", function (evt) {
        //   removeMarkers();
        ...
        //   const marker = new window.Tmapv2.Marker({
        //     position: new window.Tmapv2.LatLng(lngLat.lat, lngLat.lng),
  ...
  return <div className="map w-screen h-screen" ref={mapRef} style={{ width: "100vw", height: "100vh" }} />;
};
